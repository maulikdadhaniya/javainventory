		...
		<div id="main">
			<div class="container-fluid">
				...
				<div id="printableArea">
					...
					<thead>
					 <tr> 
					 <th colspan="3">Sales Order No: ${invoice.invoiceNo}</th> 
					 <th>  Sales Order Date: ${invoice.invoiceDate}</th>
					 </tr>
						<tr>
						<td colspan="2">
				...
				<input type="button" class="btn btn-primary" onclick="printDiv('printableArea')" value="Print Sales Order" />
				</div>
				</center>
			</div>
		</div>
