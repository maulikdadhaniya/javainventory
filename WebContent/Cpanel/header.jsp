...
<var id="userMail" value = "<%= session.getAttribute("username") %>"></var>
		...
		<div class="container-fluid">
			...
			<ul class='main-nav'>
				<li>
  				...
  				<li>
  					<a href="AddNewAdmin.jsp" class='dropdown-toggle'>
					<span>Admin</span>
					</a>
				</li>
				<li>
  					<a href="AddClient.jsp" class='dropdown-toggle'>
					<span>Client</span>
					</a>
				</li>
				<li>
					<a href="ProductCategory.jsp"  class='dropdown-toggle'>
						<span>Product Category</span>	
					</a>
				</li>
				<li>
  					<a href="ProductSubCategory.jsp" class='dropdown-toggle'>
					<span>Product Detais</span>
					</a>
				</li>
				<li>
					...
					<ul class="dropdown-menu">
						<li>
							<a href="StockPurchase.jsp">Purchase</a>
						</li>
						<li>
							<a href="StockSales.jsp">Sales</a>
						</li>
					</ul>
				</li>
				<li>
					...
					<ul class="dropdown-menu">
						<li>
							<a href="/Mini-Mouse/StockPurchaseReport">Purchase Report</a>
						</li>
						<li>
							<a href="/Mini-Mouse/StockSalesReport">Sales Report</a>
						</li>
					</ul>
				</li>
			</ul>
			<%
			AddNewAdmin obj = (AddNewAdmin) session.getAttribute("loggedUserMail");
			%>
			<div class="user">
				<div class="dropdown">
				<%
					if (obj != null) {
				%>
					<a href="#" class='dropdown-toggle' data-toggle="dropdown"><%=obj.getFirstName()%></a>
				<%
					}
				%>
					<ul class="dropdown-menu pull-right">
						...
						<li onmouseout="$(this).parent().slideUp('medium');">
							<a href="/Mini-Mouse/LogoutServlet">Sign out</a>
						</li>
					</ul>
				</div>
			</div>
