					...
					<div class="span12">
						<div class="box">
							<div class="box-content">
								<form action="StockSalesServlet" method="POST" class='form-horizontal form-validate' id="bb">
...
%>	
									...
									<div class="control-group">
										...
										<div class="controls">
											<select name="productDrop" id="productDrop" onchange="onProductChangeSetPriceandAv();" required>
...
List<ProductSubCategory> psc = objPcs.selectAll();
	...
	{ 
 %> <option value=<%=psc.get(i).getId()%>~<%=psc.get(i).getPrice()%>~<%=psc.get(i).getQuantity()%>><%=psc.get(i).getTitle()%></option>
<% 	
 } 
%>	
									...
									<div class="control-group">
										<label for="textfield" class="control-label">Available Quantity</label>
										<div class="controls">
											<input type="text" name="avlQnty" id="avlQnty" value="0" readonly="readonly" class="input-xlarge" data-rule-required="true" data-rule-minlength="2">
										</div>
									</div>
									<div class="control-group">
										<label for="textfield" class="control-label">Quantity</label>
										<div class="controls">
											<input type="text" name="txtQuantity" id="txtQuantity" value="0" onchange="onProductChangeSetPriceandAv();" class="input-xlarge" data-rule-required="true" data-rule-minlength="2" required>
										</div>
									</div>
									
									<%-- <div class="control-group">
										<label for="textfield" class="control-label">Avalable Quantity</label>
										<div class="controls">
											<input type="text" name="txtAvQuantity" id="txtAvQuantity" value="0" onkeyup="onProductChangeSetPriceandAv();" <% for(int i=0;i<psc.size();i++){
											%> <% psc.get(i).getQuantity();}%>class="input-xlarge" data-rule-required="true" data-rule-minlength="2">
										</div>
									</div>
									 --%>
									<div class="control-group">
										<label for="textfield" class="control-label">Total Sales Order Amount</label>
										<div class="controls">
